...
public class GCPixelEarthComponentVillageTorch extends GCPixelEarthComponentVillage
{
	private int averageGroundLevel = -1;

	public GCPixelEarthComponentVillageTorch()
	{
	}

	public GCPixelEarthComponentVillageTorch(GCPixelEarthComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
	{
	...
	public static StructureBoundingBox func_74904_a(GCPixelEarthComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6)
	{
