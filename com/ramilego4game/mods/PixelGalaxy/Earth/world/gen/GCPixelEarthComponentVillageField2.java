...
public class GCPixelEarthComponentVillageField2 extends GCPixelEarthComponentVillage
{
	...
	public GCPixelEarthComponentVillageField2()
	{
	}

	public GCPixelEarthComponentVillageField2(GCPixelEarthComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
	{
	...
	public static GCPixelEarthComponentVillageField2 func_74900_a(GCPixelEarthComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
	{
		...
		return GCPixelEarthComponentVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new GCPixelEarthComponentVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
