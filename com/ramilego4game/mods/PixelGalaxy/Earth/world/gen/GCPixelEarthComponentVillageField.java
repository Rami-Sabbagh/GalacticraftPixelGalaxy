...
public class GCPixelEarthComponentVillageField extends GCPixelEarthComponentVillage
{
	private int averageGroundLevel = -1;

	public GCPixelEarthComponentVillageField()
	{
	}

	public GCPixelEarthComponentVillageField(GCPixelEarthComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
	{
	...
	public static GCPixelEarthComponentVillageField func_74900_a(GCPixelEarthComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
	{
		final StructureBoundingBox var8 = StructureBoundingBox.getComponentToAddBoundingBox(par3, par4, par5, 0, 0, 0, 13, 4, 9, par6);
		return StructureComponent.findIntersecting(par1List, var8) == null ? new GCPixelEarthComponentVillageField(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
	}
