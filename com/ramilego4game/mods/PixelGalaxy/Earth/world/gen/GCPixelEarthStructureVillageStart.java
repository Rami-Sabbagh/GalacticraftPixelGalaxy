...
public class GCPixelEarthStructureVillageStart extends StructureStart
{
	public GCPixelEarthStructureVillageStart()
	{
	}

	@SuppressWarnings("unchecked")
	public GCPixelEarthStructureVillageStart(World par1World, Random par2Random, int par3, int par4, int par5)
	{
		try
		{
		...
		final ArrayList<GCPixelEarthStructureVillagePieceWeight> var6 = GCPixelEarthStructureVillagePieces.getStructureVillageWeightedPieceList(par2Random, par5);
		final GCPixelEarthComponentVillageStartPiece var7 = new GCPixelEarthComponentVillageStartPiece(par1World.getWorldChunkManager(), 0, par2Random, (par3 << 4) + 2, (par4 << 4) + 2, var6, par5);
		...
		while (var13.hasNext())
		{
			...
			if (!(var12 instanceof GCPixelEarthComponentVillageRoadPiece))
			{
				++var10;
			}
		}
