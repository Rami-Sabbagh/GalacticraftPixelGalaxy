...
public class GCPixelEarthComponentVillageWell extends GCPixelEarthComponentVillage
{
	private int averageGroundLevel = -1;

	public GCPixelEarthComponentVillageWell()
	{
	}

	public GCPixelEarthComponentVillageWell(GCPixelEarthComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, int par4, int par5)
	{
	...
	{
		GCPixelEarthStructureVillagePieces.getNextStructureComponentVillagePath((GCPixelEarthComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX - 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 1, this.getComponentType());
		GCPixelEarthStructureVillagePieces.getNextStructureComponentVillagePath((GCPixelEarthComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.maxX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ + 1, 3, this.getComponentType());
		GCPixelEarthStructureVillagePieces.getNextStructureComponentVillagePath((GCPixelEarthComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.minZ - 1, 2, this.getComponentType());
		GCPixelEarthStructureVillagePieces.getNextStructureComponentVillagePath((GCPixelEarthComponentVillageStartPiece) par1StructureComponent, par2List, par3Random, this.boundingBox.minX + 1, this.boundingBox.maxY - 4, this.boundingBox.maxZ + 1, 0, this.getComponentType());
	}
