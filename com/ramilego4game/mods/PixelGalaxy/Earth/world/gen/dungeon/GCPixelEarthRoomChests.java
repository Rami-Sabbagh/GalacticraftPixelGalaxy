...
public class GCPixelEarthRoomChests extends GCCoreDungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public GCPixelEarthRoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new GCPixelEarthRoomChests(dungeon, x, y, z, dir);
	}
