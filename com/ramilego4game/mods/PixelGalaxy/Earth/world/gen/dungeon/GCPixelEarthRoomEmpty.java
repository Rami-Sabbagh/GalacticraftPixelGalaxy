...
public class GCPixelEarthRoomEmpty extends GCCoreDungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;

	public GCPixelEarthRoomEmpty(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new GCPixelEarthRoomEmpty(dungeon, x, y, z, dir);
	}
