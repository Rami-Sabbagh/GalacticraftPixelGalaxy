...
public class GCPixelEarthRoomTreasure extends GCCoreDungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public GCPixelEarthRoomTreasure(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new GCPixelEarthRoomTreasure(dungeon, x, y, z, dir);
	}
