...
public class GCPixelEarthRoomBoss extends GCCoreDungeonRoom
{
	public int sizeX;
	public int sizeY;
	public int sizeZ;
	...
	public GCPixelEarthRoomBoss(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new GCPixelEarthRoomBoss(dungeon, x, y, z, dir);
	}
