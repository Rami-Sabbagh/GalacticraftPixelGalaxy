...
public class GCPixelEarthWorldChunkManager extends WorldChunkManager
{
	private final BiomeCache biomeCache;
	private final List<BiomeGenBase> biomesToSpawnIn;

	public GCPixelEarthWorldChunkManager()
	{
		this.biomeCache = new BiomeCache(this);
		this.biomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.biomesToSpawnIn.add(GCPixelEarthBiomeGenBase.moonFlat);
	}
	...
	{
		return GCPixelEarthBiomeGenBase.moonFlat;
	}
	...
	public float[] getTemperatures(float[] par1ArrayOfFloat, int par2, int par3, int par4, int par5)
	{
		...
		{
			float var8 = GCPixelEarthBiomeGenBase.moonFlat.getIntTemperature() / 65536.0F;
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5)
	{
		...
		for (int var7 = 0; var7 < par4 * par5; ++var7)
		{
			par1ArrayOfBiomeGenBase[var7] = GCPixelEarthBiomeGenBase.moonFlat;
		}
	...
	public BiomeGenBase[] getBiomeGenAt(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5, boolean par6)
	{
		...
		else
		{
			...
			{
				par1ArrayOfBiomeGenBase[var8] = GCPixelEarthBiomeGenBase.moonFlat;
			}
	...
	public boolean areBiomesViable(int par1, int par2, int par3, List par4List)
	{
		...
		{
			final BiomeGenBase var13 = GCPixelEarthBiomeGenBase.moonFlat;
