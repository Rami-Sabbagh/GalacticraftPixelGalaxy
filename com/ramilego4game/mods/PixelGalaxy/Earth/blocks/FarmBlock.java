...
public class FarmBlock extends Block implements ITerraformableBlock, IPlantableBlock{
	@SideOnly(Side.CLIENT)
    private Icon FarmWet;
    @SideOnly(Side.CLIENT)
    private Icon FarmDry;

	public FarmBlock(int par1) {
    ...
    {
        return par1 == 1 ? (par2 > 0 ? this.FarmWet : this.FarmDry) : GalacticraftPixelEarth.pixelDirt.getBlockTextureFromSide(par1);
    }
    ...
    {
        return GalacticraftPixelEarth.pixelDirt.blockID;
    }
    ...
    {
        this.FarmWet = par1IconRegister.registerIcon(this.getTextureName() + "_wet");
        this.FarmDry = par1IconRegister.registerIcon(this.getTextureName() + "_dry");
    }
