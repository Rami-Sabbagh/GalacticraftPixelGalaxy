...
public class PixelFluidLavaBlock extends BlockFluidClassic {
	public static IIcon LavaStill;
	public static IIcon LavaFlowing;
	...
	public IIcon getIcon(int par1, int par2) {
		return par1 != 0 && par1 != 1 ? PixelFluidLavaBlock.LavaStill : PixelFluidLavaBlock.LavaFlowing;
	}
	...
	public void registerBlockIcons(IIconRegister par1IconRegister) {
		PixelFluidLavaBlock.LavaStill = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + "Pixellava_flow");
		PixelFluidLavaBlock.LavaFlowing = par1IconRegister.registerIcon(Constants.TEXTURE_PREFIX + "Pixellava_still");
	}
