...
public class WorldGenPixelTree extends WorldGenerator {
	
	private final Block logBlock = PixelGalaxyBlocks.pixelLog;
	private final Block leaveBlock = PixelGalaxyBlocks.pixelLeaves;
    ...
    public WorldGenPixelTree(boolean notify, ItemStack sapling)
    {
        this(notify, 4, 0, 0, false);
    }

    public WorldGenPixelTree(boolean notify, int minHeight, int woodMeta, int leavesMeta, boolean vines)
    {
        super(notify);
