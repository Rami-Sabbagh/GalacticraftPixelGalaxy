...
public class BiomeDecoratorGreenPixel extends BiomeDecoratorSpace {
    ...
    public BiomeDecoratorGreenPixel()
    {
    	...
    	this.ironGen = new WorldGenMinableMeta(PixelGalaxyBlocks.pixelIronOre, 6, 1, false, PixelGalaxyBlocks.pixelStone, 1);
	...
	protected void decorate() {
		...
		this.generateOre(8, this.diamondPixelGen, 3, 10);
		this.generateOre(20, this.ironGen, 20, 64);
	}
