...
public class PixelFarmland extends Block
{
    ...
    protected PixelFarmland(Material ground)
    {
    ...
    {
        return p_149691_1_ == 1 ? (p_149691_2_ > 0 ? this.field_149824_a : this.field_149823_b) : PixelGalaxyBlocks.pixelDirt.getBlockTextureFromSide(p_149691_1_);
    }
    ...
    public void onFallenUpon(World p_149746_1_, int p_149746_2_, int p_149746_3_, int p_149746_4_, Entity p_149746_5_, float p_149746_6_)
    {
        if (!p_149746_1_.isRemote && p_149746_1_.rand.nextFloat() < p_149746_6_ - 0.5F)
        {
            ...
            p_149746_1_.setBlock(p_149746_2_, p_149746_3_, p_149746_4_, PixelGalaxyBlocks.pixelDirt);
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if (material.isSolid())
        {
            p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, PixelGalaxyBlocks.pixelDirt);
        }
    }

    public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_)
    {
        return PixelGalaxyBlocks.pixelDirt.getItemDropped(0, p_149650_2_, p_149650_3_);
    }
