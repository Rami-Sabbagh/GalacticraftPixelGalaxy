...
public class PixelIceBlock extends Block
{
    public PixelIceBlock(Material material)
    {
    	super(material);
    ...
    public void harvestBlock(World p_149636_1_, EntityPlayer p_149636_2_, int p_149636_3_, int p_149636_4_, int p_149636_5_, int p_149636_6_)
    {
        ...
        else
        {
            ...
            {
                p_149636_1_.setBlock(p_149636_3_, p_149636_4_, p_149636_5_, PixelGalaxyBlocks.PixelWaterH3OBLock);
            }
        }
    }
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (p_149674_1_.getSavedLightValue(EnumSkyBlock.Block, p_149674_2_, p_149674_3_, p_149674_4_) > 11 - this.getLightOpacity())
        {
            ...
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, PixelGalaxyBlocks.PixelWaterH3OBLock);
        }
    }
}