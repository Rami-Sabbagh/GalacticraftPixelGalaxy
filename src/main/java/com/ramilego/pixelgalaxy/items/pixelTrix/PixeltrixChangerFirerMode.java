...
public class PixeltrixChangerFirerMode extends Item {
	...
	public ItemStack onItemRightClick(ItemStack itemstack, World world, EntityPlayer entity)
	{
		...
		if(true)
		{
				...
				if(entity instanceof EntityPlayer)((EntityPlayer)entity).inventory.addItemStackToInventory(new ItemStack(PixelGalaxyItems.pixeltrix_tochangerFirerMode_ultimate, 1));
