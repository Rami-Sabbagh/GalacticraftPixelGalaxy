...
public class PixelLavaBucket extends ItemBucket {
	private Block isFull;

	public PixelLavaBucket(String name) {
		super(PixelGalaxyBlocks.pixelLavaBlock);
		this.isFull = PixelGalaxyBlocks.pixelLavaBlock;
	...
	public void registerIcons(IIconRegister iconRegister) {
		this.itemIcon = iconRegister.registerIcon(Constants.TEXTURE_PREFIX + "pixelbucketpixelava");
	}
}
