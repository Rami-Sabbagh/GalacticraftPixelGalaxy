package com.ramilego.pixelgalaxy.items.doors;
...
public class PixelItemsWoodDoor extends Item
{
    private Material doorMaterial;
    private static final String __OBFID = "CL_00000020";

    public PixelItemsWoodDoor(Material p_i45334_1_)
    {
    ...
    public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
    {
        ...
        else
        {
            ...
            {
                block = PixelGalaxyBlocks.PixelWoodDoor;
            }
